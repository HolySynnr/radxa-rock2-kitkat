...
void DisplayDevice::setProjection(int orientation,
    ...
    if (property_get("persist.sys.display.policy", property, "manaul") && !strcmp(property, "auto") > 0){
		//mFrame = viewport;
		char mproperty[PROPERTY_VALUE_MAX];
		property_get("sys.use.3dmode", mproperty, "-1");
		if(atoi(mproperty) !=6 && atoi(mproperty) != 8){
