...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    public void init(Context context, IWindowManager windowManager,
		...
		/*$_rbox_$_modify_$_zhangwen_20140219: Initialize the location of the keymouse for the first time */
       //$_rbox_$_modify_$_begin
    ...
    /** {@inheritDoc} */
/*$_rbox_$_modify_$_zhangwen_20140219: use left,righe,up,down to change the location of mouse pointer In Infrare mouse Mode  */
//$_rbox_$_modify_$_begin
