...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_TV_MEDIA_PLAY_PAUSE = 240;
    public static final int KEYCODE_TV_MEDIA_STOP = 241;
    public static final int KEYCODE_TV_MEDIA_NEXT = 242;
    public static final int KEYCODE_TV_MEDIA_PREVIOUS = 243;
    public static final int KEYCODE_TV_MEDIA_FAST_FORWARD = 244;
    public static final int KEYCODE_TV_MEDIA_REWIND = 245;
    public static final int KEYCODE_TV_MEDIA_MULT_FORWARD = 246;
    public static final int KEYCODE_TV_MEDIA_MULT_BACKWARD = 247;
    public static final int KEYCODE_TV_MEDIA_PLAY = 248;
    public static final int KEYCODE_TV_MEDIA_PAUSE = 249;
