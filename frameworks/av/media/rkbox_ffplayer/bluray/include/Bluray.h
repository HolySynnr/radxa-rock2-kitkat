...
enum BlurayOperaion
{
    ...
    KEY_PAEAMETER_BLUERAYP_PLAY_QUERY_NAVIGATION_MENU = 7024,


    // add by hh for bluray    
    MEDIA_BLURAY_ISO_MOUNT_START  = 8000,   
    MEDIA_BLURAY_ISO_MOUNT_END = 8001,    
    MEDIA_BLURAY_ISO_UNMOUNT_START = 8002,    
    MEDIA_BLURAY_ISO_UNMOUNT_END = 8003,    
    MEDIA_BLURAY_ISO_MOUNT_FAIL = 8004,    
    MEDIA_BLURAY_ISO_UNSUPPORT_FORMAT = 8005,    
    MEDIA_BLURAY_ISO_PLAY_START = 8006,    
    MEDIA_BLURAY_PLAY_NEXT  = 8007,
};
...
//    RKPlayerConfig* mRKPlayerConfig;
    ...
    int mCurrentTitleType;                        // 当前播放Title的类型
...
public:    
    ...
    int playComplete(bool userOperation,unsigned int movieObejctId);
    int playNext();
