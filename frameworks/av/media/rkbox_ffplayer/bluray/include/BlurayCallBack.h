...
#define STOP_DECODER   5
#define STOP_READ_PACKET_THREAD 6
...
public:
    ...
    virtual void configMainVideo(bool configChange,int pid,Vector<BlurayVideoConfig*>* list,int begin) = 0;
    virtual void configExtendVideo(bool configChange,int pid,Vector<BlurayVideoConfig*>* list,int begin) = 0;
    ...
    virtual void baseVideoSeek(int listPosition,int64_t offset,int64_t time) = 0;
    virtual void extendVideoSeek(int listPosition,int64_t offset,int64_t time) = 0;
