...
#define PARSER_PLAYITEM_CLIP 0
#define PARSER_EXTENSION_SUBPATH_CLIP 1
...
uint32_t clpi_lookup_spn(const CLPI_CL *cl, uint64_t timestamp, int before, uint8_t stc_id,int clip_flag);
