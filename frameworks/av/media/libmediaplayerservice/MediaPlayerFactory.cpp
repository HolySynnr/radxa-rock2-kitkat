...
/*
    ...
    if((strcmp(extension.string(),".iso") == 0) || isBDDirectory(url))
    {
...
player_type MediaPlayerFactory::getPlayerType(const sp<IMediaPlayer>& client,
    ...
    String8 extension = filePath.getPathExtension();
    extension.toLower();

    ALOGE("getPlayerType(), extension = %s",extension.string());
    if(strcmp(extension.string(),".iso") == 0 ||  isBDDirectory(filePath.string()))
    {
        return RKBOXFF_PLAYER;
    }
