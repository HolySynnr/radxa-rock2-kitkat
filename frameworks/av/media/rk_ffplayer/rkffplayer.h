...
public:
    ...
    PtsProcesser* getPtsPrcocesser();
    void setSequenece(int seq);
private:
     enum PlayerStatus{
	...
	static void 			decode(void* frame, int64_t pts,int64_t rawPts,DEC_TYPE dec_type,void *me);
	static void 			decode(int16_t* buffer, int buffer_size,int64_t pts,int64_t rawPts,int32_t dealt,void *me);
