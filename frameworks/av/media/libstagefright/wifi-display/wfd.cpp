		  ...
		  char ipAddr[PROPERTY_VALUE_MAX];
                ...
                if (colonPos == NULL) {
                    ...
                    if (*end != '\0' || end == colonPos + 1
                        ...
                        /* at first we try to get ip from dhcp property, then from arp table */
					...
					connectToHost =(AString)ipAddr;
                             ALOGE("GO Role: connect to Host %s:%d",connectToHost.c_str(),connectToPort);
                       }
                  }				
				break;
			}
