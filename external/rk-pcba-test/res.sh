...
if [ ! -e "device/rockchip/$TARGET_COMMON/app" ] ; then
    ...
    if [ -e "device/rockchip/common/bluetooth/realtek/bt/firmware/rtl8723au" ] ; then
      cp device/rockchip/common/bluetooth/realtek/bt/firmware/rtl8723au/* $PRODUCT_OUT/recovery/root/system/etc/firmware/ -a
    fi
    
    if [ -e "device/rockchip/common/bluetooth/realtek/bt/firmware/rtl8761auv" ] ; then
    cp device/rockchip/common/bluetooth/realtek/bt/firmware/rtl8761auv/* $PRODUCT_OUT/recovery/root/system/etc/firmware/ -a
    fi
