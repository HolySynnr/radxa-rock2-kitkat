...
PRODUCT_COPY_FILES += \
    ...
    device/rockchip/rksdk/ff680000_pwm.kl:system/usr/keylayout/ff680000_pwm.kl 
...
PRODUCT_COPY_FILES += \
					  device/rockchip/rksdk/pointer_arrow.raw:system/usr/pointer_arrow.raw
# For audio-recoard 
PRODUCT_PACKAGES += \
    libsrec_jni
...
#$_rbox_$_modify_$_xubilv_20120309: default disable soc camera
include hardware/rk29/camera/Config/rk32xx_camera.mk
include hardware/rk29/camera/Config/user.mk
#$_rbox_$_modify_$_chenzhi_20120309_end
...
#include device/rockchip/common/app/rkitvlauncher.mk
...
include device/rockchip/common/etc/root_device.mk
...
########################################################
# build whether or not the HDCP2.x key inside
########################################################
ifeq ($(BOARD_STORAGE_HAVE_HDCP2X_KEY),true)
    PRODUCT_PROPERTY_OVERRIDES +=   \
            ro.secure.hdcp2xkey.inside=true
else
    PRODUCT_PROPERTY_OVERRIDES +=   \
...
# for preinstall
PRODUCT_COPY_FILES += \
    device/rockchip/common/etc/install-recovery.sh:system/bin/install-recovery.sh
...
#add chrome
PRODUCT_COPY_FILES += \
       vendor/google/apps/chrome.apk:system/app/chrome.apk 
