...
public abstract class AppGridViewAdpter extends PagerAdapter
{
	...
	public AppGridViewAdpter(Context context,AllApp activity, ArrayList<PackageInformation> list)
	{
		mActivity = activity;
		mList = list;
