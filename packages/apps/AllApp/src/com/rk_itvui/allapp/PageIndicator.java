...
public class PageIndicator extends View {
    ...
    public PageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        Log.d("pageindicator","drawable:"+a.getDrawable(R.styleable.PageIndicator_dotDrawable));
        ...
        Log.d("pageindicator","gravity:"+a.getInt(R.styleable.PageIndicator_gravity, mGravity));
        setGravity(a.getInt(R.styleable.PageIndicator_gravity, mGravity));
        Log.d("pageindicator","dotType:"+a.getInt(R.styleable.PageIndicator_dotType, mDotType));
