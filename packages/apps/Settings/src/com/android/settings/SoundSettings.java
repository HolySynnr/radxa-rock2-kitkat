...
public class SoundSettings extends SettingsPreferenceFragment implements
    ...
    private static final String KEY_ES8323_MIC_SWITCH = "es8323_mic_switch";
    ...
    private Preference mES8323_MicSwitch;
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		mES8323_MicSwitch = mSoundSettings.findPreference(KEY_ES8323_MIC_SWITCH);

        try{
            File f=new File("/sys/class/es8323/mic_state/mic_state");
            if(!f.exists()){
                removePreference(KEY_ES8323_MIC_SWITCH);
            }  
        }catch (Exception e) {
            removePreference(KEY_ES8323_MIC_SWITCH);
        }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mVibrateWhenRinging) {
            ...
            // let the framework fire off the intent
            return false;
		} else if (preference == mES8323_MicSwitch){
		    return false;
		}
        return true;
    }
