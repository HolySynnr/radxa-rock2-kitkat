...
public class ScreenScaleActivity extends Activity
{
	...
	private ImageView touch_up;
	private ImageView touch_down;
	...
	private int addModel = 0;
	private int reduceModel = 1;
	private int mScaleModel = addModel;	
	...
	private void createView()
	{
		...
		touch_up = (ImageView)findViewById(R.id.screen_touch_up);
		Bitmap map = bitMapScale(R.drawable.screen_top_add);
		...
		ok = (ImageView)findViewById(R.id.button_ok);
		Bitmap okmap = bitMapScale(R.drawable.button_switch);
		y += okmap.getHeight()/2;
		...
		touch_down = (ImageView)findViewById(R.id.screen_touch_down);
		map = bitMapScale(R.drawable.screen_bottom_add);
		param = new RelativeLayout.LayoutParams(map.getWidth(),map.getHeight());
		...
		left = (ImageView)findViewById(R.id.screen_button_left);
		map = bitMapScale(R.drawable.screen_left_add);
		x += -map.getWidth()/2-10;
		...
		right = (ImageView)findViewById(R.id.screen_button_right);
		map = bitMapScale(R.drawable.screen_right_add);
		x += 10+map.getWidth()/2;
		param = new RelativeLayout.LayoutParams(map.getWidth(),map.getHeight());
			...
			switch(id)
			{
			    ...
			    if(addModel==mScaleModel){
				    if(mDisplayOutputManager != null) {
					    ...
					    if(scalevalue >=0 )
						    mDisplayOutputManager.setOverScan(mDisplayOutputManager.MAIN_DISPLAY, mDisplayOutputManager.DISPLAY_OVERSCAN_RIGHT, scalevalue);
				    }
			    }
				else if (reduceModel==mScaleModel){
				    if(mDisplayOutputManager != null) {
					     scalevalue = mDisplayOutputManager.getOverScan(mDisplayOutputManager.MAIN_DISPLAY).right - 1;
			    ...
			    if(addModel==mScaleModel){
				    if(mDisplayOutputManager != null) {
					    ...
					    if(scalevalue >=0)
						    mDisplayOutputManager.setOverScan(mDisplayOutputManager.MAIN_DISPLAY, mDisplayOutputManager.DISPLAY_OVERSCAN_LEFT, scalevalue);
				    }
				}
				else if (reduceModel==mScaleModel){
				    if(mDisplayOutputManager != null) {
			    ...
			    if(addModel==mScaleModel){
				    if(mDisplayOutputManager != null) {
					    ...
					    if(scalevalue >=0)
						    mDisplayOutputManager.setOverScan(mDisplayOutputManager.MAIN_DISPLAY, mDisplayOutputManager.DISPLAY_OVERSCAN_TOP, scalevalue);
				    }
				}
				else if (reduceModel==mScaleModel){
				    if(mDisplayOutputManager != null) {
				...
				if(addModel==mScaleModel){
				    if(mDisplayOutputManager != null) {
					    ...
					    if(scalevalue >=0 )
						    mDisplayOutputManager.setOverScan(mDisplayOutputManager.MAIN_DISPLAY, mDisplayOutputManager.DISPLAY_OVERSCAN_BOTTOM, scalevalue);
				    }
				}
				else if (reduceModel==mScaleModel){
				    // add code here
					...
					case R.id.button_ok:
					    if(addModel==mScaleModel){
			                mScaleModel=reduceModel;
			                touch_up.setImageResource(R.drawable.screen_top_reduce);
			                touch_down.setImageResource(R.drawable.screen_bottom_reduce);
			                left.setImageResource(R.drawable.screen_left_reduce);
			                right.setImageResource(R.drawable.screen_right_reduce);
			            }    
			            else if (reduceModel==mScaleModel){
			                mScaleModel=addModel;
			                touch_up.setImageResource(R.drawable.screen_top_add);
			                touch_down.setImageResource(R.drawable.screen_bottom_add);
			                left.setImageResource(R.drawable.screen_left_add);
			                right.setImageResource(R.drawable.screen_right_add);
			            }	 
					break;
			}
		}
