    ...
    */
    ...
    private void completeAddAppWidget(Intent data, CellLayout.CellInfo cellInfo) {
        ...
        if (!mRestoring) {
            ...
            launcherInfo.hostView.setFocusable(true);
            launcherInfo.hostView.setOnClickListener(this);
            launcherInfo.hostView.setBackgroundResource(R.drawable.appwidget_bg);
...
//        }
    ...
    public void onClick(View v) {
        ...
        if (tag instanceof ShortcutInfo) {
        	...
        	showAppWidgetDeleteDialog((LauncherAppWidgetInfo) tag);
        }
    }
    ...
    private LauncherAppWidgetInfo mDeleteAppWidgetInfo;
    private void showAppWidgetDeleteDialog(LauncherAppWidgetInfo info){
    	if (info == null) return;
    	mDeleteAppWidgetInfo = info;
    	Builder dialog = new AlertDialog.Builder(this)
    		.setTitle(R.string.appwidget_del_title)
    		.setMessage(R.string.appwidget_del_msg)
    		.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
				
				@Override
				public void onClick(DialogInterface dialog, int which) {
					// TODO Auto-generated method stub
					final CellLayout cellLayout = (CellLayout)mWorkspace.getChildAt(mDeleteAppWidgetInfo.screen);
					cellLayout.removeView(mDeleteAppWidgetInfo.hostView);
					removeAppWidget(mDeleteAppWidgetInfo);
					final LauncherAppWidgetHost appWidgetHost = getAppWidgetHost();
		            if (appWidgetHost != null) {
		                final int appWidgetId = mDeleteAppWidgetInfo.appWidgetId;
		            ...
		            LauncherModel.deleteItemFromDatabase(Launcher.this, mDeleteAppWidgetInfo);
		            dialog.dismiss();
				}
			})
...
*/
    ...
    public void bindAppWidget(LauncherAppWidgetInfo item) {
        ...
        item.hostView.setBackgroundResource(R.drawable.appwidget_bg);
